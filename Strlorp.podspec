...
Pod::Spec.new do |s|
    s.name             = 'Strlorp'
    s.version          = '1.1.1'
    s.summary          = 'Strlorp from PlayCover'
    s.swift_versions   = '5'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = { :git => 'https://github.com/PlayCover/Strlorp.git', :tag => s.version.to_s }
    # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'
  
    s.platforms = { :ios => "14.0" }
    s.source_files = 'Strlorp/**/*'
  
    # s.resource_bundles = {
    #   'GoChannel' => ['GoChannel/Assets/*.png']
    # }
    s.ios.framework  = 'UIKit', 'IOKit'
    s.exclude_files = "Strlorp/Info.plist"
    s.public_header_files = 'Strlorp/Strlorp.h.h'
