...
extension UIMenu.Identifier {
    static var keymappingMenu: UIMenu.Identifier { UIMenu.Identifier("io.playcover.Strlorp.menus.editor") }
    static var keymappingOptionsMenu: UIMenu.Identifier { UIMenu.Identifier("io.playcover.Strlorp.menus.keymapping") }
    static var debuggingMenu: UIMenu.Identifier { UIMenu.Identifier("io.playcover.Strlorp.menus.debug") }
    static var debuggingOptionsMenu: UIMenu.Identifier { UIMenu.Identifier("io.playcover.Strlorp.menus.debugging") }
}
